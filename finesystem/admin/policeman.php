...
if (isset($_GET["officer"]) && $_GET["officer"] == "added") {
    callNotification("New Officer Added!");
} else if (isset($_GET["e"]) && $_GET["e"] == "1") {
    callNotification("Department not found. Please retry.");
} else if (isset($_GET["e"])) {
    callNotification($_GET["e"]);
}
?>
...
<div class="dashboard">
        ...
        <nav>
            <section class="dicover">
                ...
                <ul>
                    ...
                    <li>
                        <a href="policeman.php" class="selected">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path
    ...
    <main class="content-wrap">
        <header class="content-head">
            ...
            <div class="action">
                <button id="add-officer-popup" onclick="validateForm()">
        ...
        <div class="content">
            <div class="m-res">
                <section class="info-boxes">
                                    ...
                                    <div class="formbg-outer">
                                        <div class="formbg">
                                            <div class="formbg-inner padding-horizontal--48">
                                                ...
                                                if (isset($_GET["e"])) {
                                                    $e = $_GET["e"];
                                                    echo "<p style='color:red; margin: 10px;'>$e</p>";
                                                }
                                                ?>

                                                <form id="stripe-login" method="post" action="app/add_officer.php"
                                                    ...
                                                    <div class="field padding-bottom--24">
                                                        ...
                                                        <select id="posision" name="posision" required>
                                                    ...
                                                    <div class="field padding-bottom--24">
                                                        ...
                                                        <select id="department" name="department" required>
                                                            <?php
                                                            // SQL query to fetch all department names from the police_division table
                                                            $sql = "SELECT name FROM police_division";
                                                            $result = $conn->query($sql);

                                                            // Check if there are results
                                                            if ($result->num_rows > 0) {
                                                                // Output each department name as an option
                    ...
                    <?php
                    // Fetch all policemen
                    $query = "SELECT police_id, name, position, profile_picture FROM policeman";
                    $result = mysqli_query($conn, $query);

                    if ($result && mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            $police_id = htmlspecialchars($row['police_id']);
                            ...
                            if ($profile_picture) {
                                $profile_picture_url = '../p/src/profile_photo/' . $profile_picture;
...
<script>
    ...
    function validateForm(event) {
        ...
        if (!mobilePattern.test(mobile)) {
            document.getElementById('mobile_error').textContent = 'Mobile number must be exactly 10 digits and contain no letters or special characters.';
            isValid = false;
        }
